...
with st.sidebar:
    ...
    phone_html = f'<div class="phone-container"><div class="phone-notch"></div><div class="phone-screen" style="padding-top:10px;"><div class="status-bar"><span>{now}</span><span>📶 5G 🔋</span></div><div class="sms-header"><div class="sms-header-avatar">G</div><div class="sms-header-name">Guardian Auth</div></div><div class="message-list">'
